...
const entregas = [
  "Ver o fornecedor se cadastrando e enviando os próprios documentos — sem sua equipe cobrando",
  "Rodar um checklist de qualificação técnica sem montar planilha do zero",
              ...
              {!submitted ? (
                ...
                <div className="py-12 text-center">
                  ...
                  <p className="mt-3 text-muted-foreground max-w-md mx-auto">
                    Nossa equipe libera seu acesso em até <strong className="text-primary">1 dia útil</strong> — junto
                    com o convite para a Sessão Estratégica de Conformidade.
                  </p>
                </div>
              )}
            </div>
