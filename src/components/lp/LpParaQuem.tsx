...
const sim = [
  ...
  "Está se preparando para uma certificação — primeira vez, recertificação ou transição de norma (FSSC 22000 V7, por exemplo)",
  "Sente que a documentação da cadeia de fornecedores está espalhada e sem controle real",
      ...
      <div className="lg:col-span-8 space-y-5">
        ...
        <div className="rounded-3xl border border-border bg-secondary/60 p-8 flex items-start gap-4">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">
            <strong className="text-primary">Não é pra você</strong> se sua operação já resolveu isso internamente e a
            auditoria nunca é surpresa. Aí a gente torce por você.
          </p>
        </div>
      </div>
    </div>
