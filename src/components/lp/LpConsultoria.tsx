...
const servicos = [
  ...
  { icon: Search, t: "Auditoria de 2ª parte", d: "Visão externa antes da auditoria oficial chegar." },
  { icon: ClipboardList, t: "Autoavaliação com validação técnica", d: "Não é só preencher formulário — alguém confere." },
  { icon: BadgeCheck, t: "Implementação guiada", d: "Kickoff, setup e integração dos fornecedores conduzidos com você, não entregues sozinho." },
];
    ...
    <div className="container">
      <div className="max-w-3xl">
        ...
        <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
          Toda conta MyTS vem com gente especializada olhando pra sua operação — não só um painel esperando ser preenchido.
        </p>
      </div>

      <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {servicos.map(({ icon: Icon, t, d }) => (
          <div key={t} className="rounded-3xl bg-card border border-border p-7 shadow-card hover:shadow-elegant hover:border-accent/30 transition-all">
        ...
        <div className="relative grid lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8">
            ...
            <p className="mt-4 text-primary-foreground/70 text-lg leading-relaxed max-w-2xl">
              Um consultor especialista aponta, na prática, onde a sua operação está agora e o que resolver primeiro —
              para FSSC 22000, BRCGS, IFS, BPF, APPCC/HACCP e mais.
            </p>
          </div>
