...
const depoimentos = [
  ...
  {
    q: "A MyTS foi fundamental para obter a certificação FSSC.",
    n: "Jéssica França",
    r: "Coordenadora de Gestão da Qualidade e Segurança de Alimentos",
  },
];
    ...
    <div className="container">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-4 font-display font-bold text-4xl md:text-5xl text-primary leading-tight">
          Quem já usa <span className="text-gradient">não volta pra planilha.</span>
        </h2>
      </div>
      ...
      <div className="mt-14 grid md:grid-cols-2 gap-5">
        {depoimentos.map((d) => (
          <figure key={d.n} className="rounded-3xl bg-gradient-card border border-border p-8 md:p-10 shadow-card">
            ...
            <blockquote className="mt-5 font-display text-2xl md:text-3xl text-primary leading-snug">“{d.q}”</blockquote>
